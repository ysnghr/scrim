...
function safeReadSlice(target, relPath, range, maxBytes, ctx) {
...
function safeReadStreaming(target, relPath, fileSize, ctx) {
...
function walkFiles(root, out, ig, repoRoot) {
    let entries;
    try {
