...
export function isPlaceholder(value) {
    for (const re of PLACEHOLDER_DENYLIST)
        if (re.test(value))
            return true;
    return false;
}
...
export function looksLikePunctuationGreeting(value) {
...
export function acceptGenericCredential(value, opts) {
    ...
    if (looksLikeUrl(value))
        return false;
    if (looksLikePunctuationGreeting(value))
        return false;
