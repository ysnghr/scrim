...
export function detectStreaming(filePath, cfg, opts = {}) {
    ...
    try {
        ...
        for (const d of collected)
            byKey.set(`${d.span.start}:${d.span.end}:${d.span.ruleId}`, d);
