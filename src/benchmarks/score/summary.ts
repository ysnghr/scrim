...
import type { RunnerScore, ClassScore } from "../types.js";
import type { PerfResult } from "../perf.js";
import type { SurvivabilityResult } from "../survivability.js";
...
function classRow(s: ClassScore): string[] {
  return [
    String(s.klass),
